...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Agent.parent'
        db.alter_column(u'instructor_agent', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['instructor.Agent'], null=True))

    def backwards(self, orm):

        # Changing field 'Agent.parent'
        db.alter_column(u'instructor_agent', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['instructor.Agent']))
    ...
    models = {
        u'instructor.agent': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['instructor.Agent']", 'null': 'True'})
        },
