...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Agent.parent'
        db.delete_column(u'instructor_agent', 'parent_id')


    def backwards(self, orm):
        # Adding field 'Agent.parent'
        db.add_column(u'instructor_agent', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['instructor.Agent'], null=True),
                      keep_default=False)
