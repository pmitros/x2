...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TableBlock.session'
        db.add_column(u'instructor_tableblock', 'session',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['instructor.Session']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TableBlock.session'
        db.delete_column(u'instructor_tableblock', 'session_id')
