...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HelpRequest.requested_at'
        db.add_column(u'instructor_helprequest', 'requested_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 14, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HelpRequest.requested_at'
        db.delete_column(u'instructor_helprequest', 'requested_at')
    ...
    models = {
        ...
        u'instructor.helprequest': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'requested_at': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
