...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Interaction.instructor_summary'
        db.add_column(u'instructor_interaction', 'instructor_summary',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Interaction.instructor_summary'
        db.delete_column(u'instructor_interaction', 'instructor_summary')
